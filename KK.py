...
#line = LINE()
#line = LINE("เมล","พาส")
line = LINE('EQ93uRfRngpsBSIYUKV4.gp9qJlqT+x+ScUB9XwoS1a.QVPlooynv6Aaj9WXQwoIX22MJ58KYhBhI2G+nOZP13M=')
    ...
    try:
        ...
        if op.type == 5:
            ...
            if settings["autoAdd"] == True:
                line.sendMessage(op.param1, "สวัสดี {} ขอบคุณที่แอดมา".format(str(line.getContact(op.param1).displayName)))
#                nadya.sendMessage(op.param1, str(settings["welcome"]))
                line.sendMessage(op.param1, "สนใจเช่าบอทติดต่อ")
                line.sendContact(op.param1,  "u24d5f93f9113c991342c079005467e2f")
#                nadya.sendMessage(op.param1, "ต้องการบอทแทค.. ท่านสามารถเชิญผมเข้ากลุ่มได้เลย\n\nแล้วใช้คำสั่ง แทค หรือ /1 ก็สามารถแท็กคนทั้งกลุ่มได้เลยครับ")
        if op.type == 13:
            ...
            if settings["autoJoin"] == True:
                ...
                line.sendMessage(op.param1, "allpage")
        if op.type == 13:
...
#==============FINNISHING PROTECT========================#
                ...
                if settings["checkContact"] == True:
                    try:
                        ...
                        try:
                            line.sendImageWithURL(to, str(pathh))
                        except:
                            pass
...
#                        line.sendMessage(to, str(ret_))
                ...
                if settings["checkSticker"] == True:
                    ...
                    ret_ += "\n╚══[ VҜ ŚẾL₣ВΌŦ ]"
#                    line.sendMessage(to, "Allscanwin")
#                    line.sendMessage(to, str(ret_))
